...
if( function_exists('edd_get_settings') ) {
	...
	************************************************/
	...
	function edds_set_download_labels($labels) {
		$labels = array(
			'name' => _x('Themes', 'post type general name', 'dsc'),
			'singular_name' => _x('Theme', 'post type singular name', 'dsc'),
			'add_new' => __('Add New', 'dsc'),
			'add_new_item' => __('Add New Theme', 'dsc'),
			'edit_item' => __('Edit Theme', 'dsc'),
			'new_item' => __('New Theme', 'dsc'),
			'all_items' => __('All Themes', 'dsc'),
			'view_item' => __('View Theme', 'dsc'),
			'search_items' => __('Search Themes', 'dsc'),
			'not_found' =>  __('No Themes found', 'dsc'),
			'not_found_in_trash' => __('No Themes found in Trash', 'dsc'), 
			'parent_item_colon' => '',
			'menu_name' => __('Themes', 'dsc')
		);
		return $labels;
	}
